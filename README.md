...
![ExpenseTracker AI](https://img.shields.io/badge/Next.js-15.4.5-black?style=for-the-badge&logo=next.js)
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/farrelsp/expense-tracker-ai.git
...
**Built with ❤️ by [Farrel](https://github.com/farrelsp)**
